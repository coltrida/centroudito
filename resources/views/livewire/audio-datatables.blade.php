    ...
    <div class="w-10/12">
        ...
        <form class="my-4" wire:submit.prevent="addAudioprotesista">
            <div class="flex">
                ...
                <input wire:model.lazy="id_filiale" type="text" style="color: black" class="w-full rounded border shadow p-2 mr-2 my-2" placeholder="filiale">
            </div>
            <div class="py-2">
        ...
        @foreach($audioprotesisti as $item)
            <div class="rounded border p-3 my-2" style=" box-shadow: 2px 2px 4px #000000;">
                <div class="row justify-between my-1">
                    <div class="col">
                    ...
                    <div class="col">
                        <p class="font-bold text-lg">{{$item->id_filiale}}</p>
                    </div>
                    <div class="col-1">
