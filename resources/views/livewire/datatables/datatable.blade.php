<div xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <div class="relative">
            ...
            <div class="flex-grow h-10 flex items-center">
                ...
                <div class="w-96 flex rounded-lg shadow-sm">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" style="padding: 10px 0 10px 40px" class="form-input block bg-gray-50 focus:bg-white w-full rounded-md pl-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Search in {{ $this->searchableColumns()->map->label->join(', ') }}" />
        ...
        <div class="rounded-lg shadow-lg bg-white max-w-screen overflow-x-scroll mt-3">
