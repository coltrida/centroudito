...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div style="background-color: #052e3c" class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900  sm:pt-0">
            @auth
                <div class="container my-5 dark:text-white">
                   @yield('main')
               </div>
            @endauth
        </div>
